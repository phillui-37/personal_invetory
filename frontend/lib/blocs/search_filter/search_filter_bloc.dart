...
class SearchFilterBloc extends Bloc<SearchFilterEvent, SearchFilterState> {
  ...
  void _onUpdateSelectedTags(UpdateSelectedTags event, Emitter<SearchFilterState> emit) {
  ...
  void _onUpdateSortOrder(UpdateSortOrder event, Emitter<SearchFilterState> emit) {
    emit(state.copyWith(sortOrder: event.sortOrder));
  }
  void _onUpdateFilterLogic(UpdateFilterLogic event, Emitter<SearchFilterState> emit) {
